...
function contentfreaks_enqueue_scripts() {
    ...
    if (is_front_page()) {
        ...
        wp_enqueue_style('contentfreaks-media-kit', get_stylesheet_directory_uri() . '/page-media-kit.css', array('contentfreaks-components'), '1.0.1');
        ...
        wp_enqueue_style('contentfreaks-single', get_stylesheet_directory_uri() . '/single.css', array('contentfreaks-components'), '1.1.0');
